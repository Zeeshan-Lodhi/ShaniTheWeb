...
import img from '../pics/logob.png';
                        ...
                        <div className="col-12 ">
                            ...
                            <nav className="navbar navbar-expand-lg navbar-light  nav_bg">
                                <div className="container-fluid">
                                    <img src={img} className="logoimg" style={{ width: "40px", height: "40px" }} alt="logo" />
                                    <NavLink className="navbar-brand" to="">Zeeshan Lodhi</NavLink>
